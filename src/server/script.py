...
def generate_flight_records(start_date, end_date, num_records):
    ...
    while cur.day == today.day:
        ...
        time_start = cur + timedelta(minutes=15 * random.randint(4, 10))
...
def gen_class():
    ...
    for id_flight in range(110, 120):  # idFlight từ 5 đến 83
    ...
    # In câu lệnh SQL
    print("INSERT INTO classflight (idclassFlight, class, seatAmount, seatBooked, currentPrice, idFlight) VALUES")
    print(",\n".join(sql_values) + ";")
...
# In SQL script
print("INSERT INTO flight (idFlight, timeStart, timeEnd, idbeginAirport, idendAirport, idAirplane, idAdmin_created) VALUES")
print(",\n".join(flight_records) + ";")
gen_class()